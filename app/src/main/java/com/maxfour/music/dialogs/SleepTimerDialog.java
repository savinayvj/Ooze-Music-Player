    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        materialDialog = new MaterialDialog.Builder(getActivity())
                ...
                .onPositive((dialog, which) -> {
                    ...
                    PendingIntent pi = makeTimerPendingIntent(PendingIntent.FLAG_IMMUTABLE);
                ...
                .onNeutral((dialog, which) -> {
                    ...
                    final PendingIntent previous = makeTimerPendingIntent(PendingIntent.FLAG_IMMUTABLE);
                    if (previous != null) {
                        AlarmManager am = (AlarmManager) getActivity().getSystemService(Context.ALARM_SERVICE);
                        am.cancel(previous);
                        previous.cancel();
                ...
                .showListener(dialog -> {
                    if (makeTimerPendingIntent(PendingIntent.FLAG_IMMUTABLE) != null) {
                        timerUpdater.start();
                    }
                })
